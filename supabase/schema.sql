...
create policy "allow anonymous support submissions" on public.support_requests for insert to anon,authenticated with check(length(email) between 5 and 320 and length(issue) between 5 and 4000 and platform in ('Google','Microsoft','Discord','Facebook','X'));
